...
public class LSMuonSachDao {
    ...
    public List<LSMuonSach> getListLSMuonSach(String madocgia) {
        ...
        String sql = "select a.ngaymuon, a.hantra, b.masach, b.record_status, c.tensach from tbphieumuon as a inner join tbctphieumuon as b inner join tbsach as c on a.maphieumuon = b.maphieumuon and b.masach = c.masach where a.record_status = 1 and a.madocgia=? orderby a.ngaymuon desc";
